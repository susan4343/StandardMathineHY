    ...
    public class Robot_EPSON : RobotBase
    {
        ...
        public override string ProcessResponse(string ResponseString)
        {
            ...
            try
            {
                ...
                //格式：![远程命令],[错误代码]终端
                if (ResponseString == "") { MessageBox.Show("没收到控制器的答复", "Warn", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1, MessageBoxOptions.DefaultDesktopOnly); return TempResponse + "没收到控制器的答复"; }
        ...
        public override bool SetPointPos(string PointID, string strLabel, PositionInfo NewPointData)
        {
            ...
            catch (Exception ex)
            {
                ...
                EpsonErrLog.ErrorMess = ex.Message; ;
                EpsonErrLog.ErrorCmd = "SetPointPos";
                MessageBox.Show("SetPointPos" + ex.ToString(), "Warn", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1, MessageBoxOptions.DefaultDesktopOnly);
                //ErrorDisPlay(this, ea);
                return false;
            }
        }
        ...
        public override bool SetOutputBit(int TargetOutputBit, bool TurnOn)
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("The parameter 'TargetOutputBit' should be 0~15, please revise it and retry.", "Warn", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1, MessageBoxOptions.DefaultDesktopOnly);
                    return false;
                }
