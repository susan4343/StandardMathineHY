...
namespace MotionIoLib
{
    ...
    {
        ClosedLoopStepping,//闭环步进
        SEVERWaitNot,// 上电自动使能的伺服
        EcatAxis,
        EcatAxisModleSevro,
        SEVER,
    ...
    public abstract class MotionCardBase
    {
        ...
        public virtual bool CloseAxisGroup(ref IntPtr group)
        {
            return true;
        }
        public virtual GpState GetGpState(IntPtr group)
        {

            return GpState.GpDisable;
        }
        public virtual bool StopGp(IntPtr group)
        {
            return true;
        }
        ...
        public virtual bool ResetGpErr(IntPtr group)
        {
            return true;
        }
    ...
    public class MotionMgr
    {
        ...
        public void AddCard(string strName, ulong nCardNo, int nAxisMin, int nAxisMax)
        {
            ...
            if (flag)
            {
                throw new Exception(string.Format("运动控制卡{0}找不到可用的封装类，请确认motionio.dll是否正确或配置错误?" + strName, new object[1]));
            }
        ...
        public double GetAxisPos(int nAxisNo)
        {
            ...
            if (tempCardBase != null)
            {
                ...
                if (rate == 0)
                    rate = 1;
                return tempCardBase.GetAxisPos(nAxis) / rate;
            }
            else
                return int.MaxValue;
        }
        ...
        public static bool m_bExit = false;
        ...
        Dictionary<string, MoveGroup> m_dicGroup = new Dictionary<string, MoveGroup>();
        ...
        public bool AddAxisToGroup(string GroupName, int Number, int[] nAxisArr)
        {
            ...
            try
            {
                if ((bool)tempCardBase?.AddAxisToGroup(moveGroup._nAxisArr, ref intPtr))
                {
                    ...
                    if (m_dicGroup.Keys.Contains(GroupName))
                    {
                        m_dicGroup[GroupName] = moveGroup;
                    }
                    else
                    {
                        m_dicGroup.Add(GroupName, moveGroup);
                    }
        ...
        public GpState GetGpState(string strGpName)
        {
            if (m_dicGroup.ContainsKey(strGpName))
            {
                ...
                return moveGroup._pCard.GetGpState(intPtrgroup);
        ...
        public bool RestGpErr(string strGpName)
        {
            if (m_dicGroup.ContainsKey(strGpName))
            {
                ...
                IntPtr intPtrgroup = (IntPtr)moveGroup._pGroup;
                return moveGroup._pCard.ResetGpErr(intPtrgroup);
        ...
        public void CloseAxisToGroup(string GroupName)
        {
            if (m_dicGroup.ContainsKey(GroupName))
            {
                ...
                IntPtr intPtr = (IntPtr)m_dicGroup[GroupName]._pGroup;
                tempCardBase.CloseAxisGroup(ref intPtr);
            }
        }
        ///群组 添加运动
                        ...
                        case BufMotionType.buf_Arc2dAbsAngleCCW:
                            ...
                            if (tem._point1 != null)
                            {
                                ...
                                for (int i = 0; i < tem._point1.Length; i++)
                                {
                                    ...
                                    acc1 = GetAxisSpeed(moveGroup._nSysAxisArr[i], tem._VelHigh);
                                }
                        ...
                        case BufMotionType.buf_Arc2dAbsAngleCW:
                            ...
                            if (tem._point1 != null)
                            {
                                ...
                                for (int i = 0; i < tem._point1.Length; i++)
                                {
                                    ...
                                    acc2 = GetAxisSpeed(moveGroup._nSysAxisArr[i], tem._VelHigh);
                                }
                        ...
                        default:
                            ...
                            if (tem._point1 != null)
                            {
                                ...
                                for (int i = 0; i < tem._point1.Length; i++)
                                {
                                    ...
                                    acc3 = GetAxisSpeed(moveGroup._nSysAxisArr[i], tem._VelHigh);
                                }
