      ...
      void UpdatadataGridView_PointInfo()
        ...
        public void ChangedIoOutState(string IoName, bool bStateCurrent)
        {
            ...
            else
            {
                ...
                {
                    // 
                    //Graphics graphics = Graphics.FromHwnd(dataGridView_IoOutput.Handle);
                    ...
                    //     //{
                    //     //    graphics.FillRectangle(brush, dataGridView_IoOutput.Rows[nRow].Cells[1].ContentBounds);
                    //     //    dataGridView_IoOutput.UpdateCellValue(nRow, 1);
                    //     //}
                    // }
                    //else
                    // {
        ...
        public void UpdateRobotStatus(ControlInfo controlInfo)
        {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("获取机械人状态异常" + ex.ToString(), "Warn", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1, MessageBoxOptions.DefaultDesktopOnly);
            }
        ...
        public void OutPutSignalPictureBoxArray_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (OutputBitStatus[TempOutputBit] == false)
                {
                    ...
                    {
                        MessageBox.Show("Failed to set output bit " + (TempOutputBit + 1) + " ON...", "Warn", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1, MessageBoxOptions.DefaultDesktopOnly);
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    {
                        MessageBox.Show("Failed to set output bit " + (TempOutputBit + 1) + " OFF...", "Warn", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1, MessageBoxOptions.DefaultDesktopOnly);
                    }
                    else
                    {
            ...
            {
                MessageBox.Show(ex.Message, "Warn", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1, MessageBoxOptions.DefaultDesktopOnly);
            }
