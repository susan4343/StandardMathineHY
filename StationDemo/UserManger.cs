...
namespace StationDemo
{
    public partial class UserManger : Form, IUserRightSwitch
    {
        ...
        public void ChangedUserRight(User CurrentUser)
        {
            ...
            {
                UserConfig.userRight = userRight;
                return;
            }
            if (InvokeRequired)
            {
        ...
        private void UserManger_Load(object sender, EventArgs e)
        {
            ...
            CbxLoadPatten.Items.Clear();
            CbxLoadPatten.Items.Add( "手动上料");
            CbxLoadPatten.Items.Add( "气缸上料" );
            CbxLoadPatten.Text = SysFunConfig.LoadPatten;
             chbIsLRUV.Checked =SysFunConfig.IsLRUV;
