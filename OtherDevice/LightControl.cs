...
namespace OtherDevice
{
    ...
    public class LightControler
    {
        ...
        public object ReadParam()
        {
            ...
            try
            {
                obj = AccessXmlSerializer.XmlToObject(AppDomain.CurrentDomain.BaseDirectory + @"config\Light_" + LightName + ".xml", lightSerialPortParam.GetType());
                if (obj != null)
        ...
        public void Save()
        {
            string strPath = AppDomain.CurrentDomain.BaseDirectory + @"\config\Light_" + LightName + ".xml";
        ...
        public bool SerialSend(string command)
        {
            ...
            {
                MessageBox.Show("发送数据时发生错误！" + ex.Message, "Warn", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1, MessageBoxOptions.DefaultDesktopOnly);
            }
            return true;
        }
